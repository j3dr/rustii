...
### Linux
Just download the appropriate binary from [latest release](https://github.com/j3dr/rustii/releases/latest) and copy it to a directory specified in your `$PATH`, for example:

`sudo cp rustii /usr/bin`

### Windows
1. Download **rustii.exe** from [latest release](https://github.com/j3dr/rustii/releases/latest)
...
![image](https://github.com/j3dr/rustii/assets/164680506/75be086c-67c5-4e84-a3f3-3c65d4af80ec)

`rustii render catedral.jpg --output ascii.txt --scale 0.13 0.053`
![image(1)](https://github.com/j3dr/rustii/assets/164680506/26d32faf-1748-4c36-b6f7-525d30b38fe2)

`rustii render woman.jpg --output ascii.txt --scale 0.09 0.032 --contrast -5`
![image(2)](https://github.com/j3dr/rustii/assets/164680506/4c7d2e76-3536-4e92-9e4d-98cc1d1a502a)
